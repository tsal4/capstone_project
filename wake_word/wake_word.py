...
def speech_to_text(filename):
    """Converts the recorded speech into text using OpenAI's Whisper model."""
...
def get_response(prompt):
    """Sends user text to GPT and returns a conversational response."""
    print("Thinking...")
...
def speak(text):
    """Speaks the provided text aloud using pyttsx3."""
    print("Speaking...")
    engine = pyttsx3.init()
    engine.say(text)
    engine.runAndWait()
